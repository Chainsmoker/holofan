var camera, scene, renderer,
    geometry, material, mesh, composer, filmPass;
...
function init() {
 ...
 /*
    ...
    **/
    ...
    smokeMaterial = new THREE.MeshLambertMaterial({color: new THREE.Color("rgb(212, 212, 214)"), map: smokeTexture, transparent: true});
