...
const cRadius = gui.add(u.uRadius, "value", 2, 2.3, 0.01)
.name("scale")
...
.onUpdate(({ radius, spin, randomness, rotate }) => {
  ...
  galaxy.rotation.y = 30
  galaxy.rotation.x = 180
...
setTimeout(()=>{
  ...
  document.querySelector(".splash-logo").style.opacity = 1
}, 5000)


document.querySelector(".btn-explore").addEventListener("click", ()=>{
  document.querySelector(".splash").classList.add("close")
  setTimeout(()=>{
